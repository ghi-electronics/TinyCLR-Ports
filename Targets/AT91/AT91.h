...
struct AT91XX_TIMER {
    ...
    static uint32_t inline getIntNo(int Timer) {
        switch (Timer) {
            case  c_Timer_0:
                return AT91XX_VIC::c_IRQ_INDEX_TIMER0;
                break;
            case  c_Timer_1:
                return AT91XX_VIC::c_IRQ_INDEX_TIMER1;
                break;
            case  c_Timer_2:
                return AT91XX_VIC::c_IRQ_INDEX_TIMER2;
                break;
            case  c_Timer_3:
                return AT91XX_VIC::c_IRQ_INDEX_TIMER3;
                break;
            default:
                return(Timer);
                break;
...
struct AT91XX_USART {
    ...
    static const uint32_t c_ClockRate = AT91_UART_PCLK;
    ...
    static uint32_t inline getIntNo(int ComPortNum) {
        switch (ComPortNum) {
            case c_Uart_0:
                return AT91XX_VIC::c_IRQ_INDEX_UART0;
                break;
            case c_Uart_1:
                return AT91XX_VIC::c_IRQ_INDEX_UART1;
                break;
            case c_Uart_2:
                return AT91XX_VIC::c_IRQ_INDEX_UART2;
                break;
            case c_Uart_3:
                return AT91XX_VIC::c_IRQ_INDEX_UART3;
                break;
            default:
                return(ComPortNum);
                break;
...
struct AT91XX_I2C {
    ...
    static const uint32_t c_I2C_Clk_KHz = AT91_I2C_PCLK_KHZ;
...
struct AT91XX_SPI {
    ...
    static const uint32_t c_SPI_Clk_KHz = AT91_SPI_PCLK_KHZ;
...
struct AT91XX {
    static AT91XX_VIC    & VIC() { return *(AT91XX_VIC    *)(size_t)(AT91XX_VIC::c_VIC_Base); }
    //static AT91XX_GPIO   & GPIO   (         ) { return *(AT91XX_GPIO   *)(size_t)(      AT91XX_GPIO  ::c_GPIO_Base                                 ); }
    //static AT91XX_GPIOIRQ   & GPIOIRQ   (         ) { return *(AT91XX_GPIOIRQ   *)(size_t)(      AT91XX_GPIOIRQ  ::c_GPIOIRQ_Base                                 ); }
    static AT91XX_PCB    & PCB() { return *(AT91XX_PCB    *)(size_t)(AT91XX_PCB::c_PCB_Base); }
    static AT91XX_SYSCON & SYSCON() { return *(AT91XX_SYSCON *)(size_t)(AT91XX_SYSCON::c_SYSCON_Base); }
    //static AT91XX_EMC    & EMC    (         ) { return *(AT91XX_EMC    *)(size_t)(      AT91XX_EMC   ::c_EMC_Base                                  ); }
    static AT91XX_SPI    & SPI(int sel) { return *(AT91XX_SPI    *)(size_t)((sel == 0) ? (AT91XX_SPI::c_SPI0_Base) : (AT91XX_SPI::c_SPI1_Base)); }
    static AT91XX_I2C    & I2C() { return *(AT91XX_I2C    *)(size_t)(AT91XX_I2C::c_I2C_Base); }
    static AT91XX_WATCHDOG & WTDG() { return *(AT91XX_WATCHDOG *)(size_t)(AT91XX_WATCHDOG::c_WATCHDOG_Base); }
    //static AT91XX_DAC    & DAC    (         ) { return *(AT91XX_DAC    *)(size_t)(      AT91XX_DAC   ::c_DAC_Base                                  ); }


    static AT91XX_TIMER  & TIMER(int sel) {

        if (sel == AT91XX_TIMER::c_Timer_0)
            return *(AT91XX_TIMER  *)(size_t)AT91XX_TIMER::c_TimerBase_0;
        else if (sel == AT91XX_TIMER::c_Timer_1)
            return *(AT91XX_TIMER  *)(size_t)AT91XX_TIMER::c_TimerBase_1;
        else if (sel == AT91XX_TIMER::c_Timer_2)
            return *(AT91XX_TIMER  *)(size_t)AT91XX_TIMER::c_TimerBase_2;
        else
            return *(AT91XX_TIMER  *)(size_t)AT91XX_TIMER::c_TimerBase_3;
    }

    static AT91XX_USART  & UART(int sel) {

        if (sel == AT91XX_USART::c_Uart_0)
            return *(AT91XX_USART  *)(size_t)AT91XX_USART::c_UartBase_0;
        else if (sel == AT91XX_USART::c_Uart_1)
            return *(AT91XX_USART  *)(size_t)AT91XX_USART::c_UartBase_1;
        else if (sel == AT91XX_USART::c_Uart_2)
            return *(AT91XX_USART  *)(size_t)AT91XX_USART::c_UartBase_2;
        else
            return *(AT91XX_USART  *)(size_t)AT91XX_USART::c_UartBase_3;
    }
    //--//
};
