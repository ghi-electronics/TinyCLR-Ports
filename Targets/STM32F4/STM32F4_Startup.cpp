...
#if defined STM32F4_VCO_IN_CLOCK_HZ && defined STM32F4_VCO_OUT_CLOCK_HZ

#define RCC_PLLCFGR_PLLM_BITS	(STM32F4_EXT_CRYSTAL_CLOCK_HZ / STM32F4_VCO_IN_CLOCK_HZ << RCC_PLLCFGR_PLLM_Pos & RCC_PLLCFGR_PLLM_Msk)
#define RCC_PLLCFGR_PLLN_BITS	(STM32F4_VCO_OUT_CLOCK_HZ     / STM32F4_VCO_IN_CLOCK_HZ << RCC_PLLCFGR_PLLN_Pos & RCC_PLLCFGR_PLLN_Msk)
#define RCC_PLLCFGR_PLLQ_BITS	(STM32F4_VCO_OUT_CLOCK_HZ     / 48000000                << RCC_PLLCFGR_PLLQ_Pos & RCC_PLLCFGR_PLLQ_Msk)
#if STM32F4_VCO_OUT_CLOCK_HZ / STM32F4_SYSTEM_CLOCK_HZ == 2
#define RCC_PLLCFGR_PLLP_BITS	(0 << RCC_PLLCFGR_PLLP_Pos & RCC_PLLCFGR_PLLP_Msk)
#elif STM32F4_VCO_OUT_CLOCK_HZ / STM32F4_SYSTEM_CLOCK_HZ == 4
#define RCC_PLLCFGR_PLLP_BITS	(1 << RCC_PLLCFGR_PLLP_Pos & RCC_PLLCFGR_PLLP_Msk)
#elif STM32F4_VCO_OUT_CLOCK_HZ / STM32F4_SYSTEM_CLOCK_HZ == 6
#define RCC_PLLCFGR_PLLP_BITS	(2 << RCC_PLLCFGR_PLLP_Pos & RCC_PLLCFGR_PLLP_Msk)
#elif STM32F4_VCO_OUT_CLOCK_HZ / STM32F4_SYSTEM_CLOCK_HZ == 8
#define RCC_PLLCFGR_PLLP_BITS	(3 << RCC_PLLCFGR_PLLP_Pos & RCC_PLLCFGR_PLLP_Msk)
#else
#error illegal STM32F4_VCO_OUT_CLOCK_HZ / STM32F4_SYSTEM_CLOCK_HZ
#endif
