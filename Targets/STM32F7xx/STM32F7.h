...
TinyCLR_Result STM32F7_Time_Acquire(const TinyCLR_Time_Provider* self);
TinyCLR_Result STM32F7_Time_Release(const TinyCLR_Time_Provider* self);
uint64_t STM32F7_Time_GetCurrentProcessorTicks(const TinyCLR_Time_Provider* self);
uint64_t STM32F7_Time_GetTimeForProcessorTicks(const TinyCLR_Time_Provider* self, uint64_t ticks);
uint64_t STM32F7_Time_GetProcessorTicksForTime(const TinyCLR_Time_Provider* self, uint64_t time);
TinyCLR_Result STM32F7_Time_SetTickCallback(const TinyCLR_Time_Provider* self, TinyCLR_Time_TickCallback callback);
TinyCLR_Result STM32F7_Time_SetNextTickCallbackTime(const TinyCLR_Time_Provider* self, uint64_t processorTicks);
void STM32F7_Time_Delay(const TinyCLR_Time_Provider* self, uint64_t microseconds);
void STM32F7_Time_DelayNoInterrupt(const TinyCLR_Time_Provider* self, uint64_t microseconds);
...
TinyCLR_Result STM32F7_Can_Acquire(const TinyCLR_Can_Provider* self);
TinyCLR_Result STM32F7_Can_Release(const TinyCLR_Can_Provider* self);
TinyCLR_Result STM32F7_Can_SoftReset(const TinyCLR_Can_Provider* self);
TinyCLR_Result STM32F7_Can_WriteMessage(const TinyCLR_Can_Provider* self, uint32_t arbitrationId, bool isExtendedId, bool isRemoteTransmissionRequest, uint8_t* data, size_t length);
TinyCLR_Result STM32F7_Can_ReadMessage(const TinyCLR_Can_Provider* self, uint32_t& arbitrationId, bool& isExtendedId, bool& isRemoteTransmissionRequest, uint64_t& timestamp, uint8_t* data, size_t& length);
TinyCLR_Result STM32F7_Can_SetBitTiming(const TinyCLR_Can_Provider* self, int32_t propagation, int32_t phase1, int32_t phase2, int32_t baudratePrescaler, int32_t synchronizationJumpWidth, int8_t useMultiBitSampling);
TinyCLR_Result STM32F7_Can_GetUnreadMessageCount(const TinyCLR_Can_Provider* self, size_t& count);
TinyCLR_Result STM32F7_Can_SetMessageReceivedHandler(const TinyCLR_Can_Provider* self, TinyCLR_Can_MessageReceivedHandler handler);
TinyCLR_Result STM32F7_Can_SetErrorReceivedHandler(const TinyCLR_Can_Provider* self, TinyCLR_Can_ErrorReceivedHandler handler);
TinyCLR_Result STM32F7_Can_SetExplicitFilters(const TinyCLR_Can_Provider* self, uint8_t* filters, size_t length);
TinyCLR_Result STM32F7_Can_SetGroupFilters(const TinyCLR_Can_Provider* self, uint8_t* lowerBounds, uint8_t* upperBounds, size_t length);
TinyCLR_Result STM32F7_Can_ClearReadBuffer(const TinyCLR_Can_Provider* self);
TinyCLR_Result STM32F7_Can_IsWritingAllowed(const TinyCLR_Can_Provider* self, bool& allowed);
TinyCLR_Result STM32F7_Can_GetWriteErrorCount(const TinyCLR_Can_Provider* self, size_t& count);
TinyCLR_Result STM32F7_Can_GetReadErrorCount(const TinyCLR_Can_Provider* self, size_t& count);
TinyCLR_Result STM32F7_Can_GetSourceClock(const TinyCLR_Can_Provider* self, uint32_t& sourceClock);
TinyCLR_Result STM32F7_Can_GetReadBufferSize(const TinyCLR_Can_Provider* self, size_t& size);
TinyCLR_Result STM32F7_Can_SetReadBufferSize(const TinyCLR_Can_Provider* self, size_t size);
TinyCLR_Result STM32F7_Can_GetWriteBufferSize(const TinyCLR_Can_Provider* self, size_t& size);
TinyCLR_Result STM32F7_Can_SetWriteBufferSize(const TinyCLR_Can_Provider* self, size_t size);
...
TinyCLR_Result STM32F7_Dac_Acquire(const TinyCLR_Dac_Provider* self);
TinyCLR_Result STM32F7_Dac_Release(const TinyCLR_Dac_Provider* self);
TinyCLR_Result STM32F7_Dac_AcquireChannel(const TinyCLR_Dac_Provider* self, int32_t channel);
TinyCLR_Result STM32F7_Dac_ReleaseChannel(const TinyCLR_Dac_Provider* self, int32_t channel);
TinyCLR_Result STM32F7_Dac_WriteValue(const TinyCLR_Dac_Provider* self, int32_t channel, int32_t value);
int32_t STM32F7_Dac_GetMinValue(const TinyCLR_Dac_Provider* self);
int32_t STM32F7_Dac_GetMaxValue(const TinyCLR_Dac_Provider* self);
int32_t STM32F7_Dac_GetResolutionInBits(const TinyCLR_Dac_Provider* self);
...
TinyCLR_Result STM32F7_Gpio_Acquire(const TinyCLR_Gpio_Provider* self);
TinyCLR_Result STM32F7_Gpio_Release(const TinyCLR_Gpio_Provider* self);
TinyCLR_Result STM32F7_Gpio_AcquirePin(const TinyCLR_Gpio_Provider* self, int32_t pin);
TinyCLR_Result STM32F7_Gpio_ReleasePin(const TinyCLR_Gpio_Provider* self, int32_t pin);
TinyCLR_Result STM32F7_Gpio_Read(const TinyCLR_Gpio_Provider* self, int32_t pin, TinyCLR_Gpio_PinValue& value);
TinyCLR_Result STM32F7_Gpio_Write(const TinyCLR_Gpio_Provider* self, int32_t pin, TinyCLR_Gpio_PinValue value);
bool STM32F7_Gpio_IsDriveModeSupported(const TinyCLR_Gpio_Provider* self, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
TinyCLR_Gpio_PinDriveMode STM32F7_Gpio_GetDriveMode(const TinyCLR_Gpio_Provider* self, int32_t pin);
TinyCLR_Result STM32F7_Gpio_SetDriveMode(const TinyCLR_Gpio_Provider* self, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
