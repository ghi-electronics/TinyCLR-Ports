...
uint64_t STM32F7_Time_GetSystemTime(const TinyCLR_NativeTime_Controller* self);
...
//USB Host
////////////////////////////////////////////////////////////////////////////////
void STM32F7_UsbHost_AddApi(const TinyCLR_Api_Manager* apiManager);
TinyCLR_Result STM32F7_UsbHost_Reset();
