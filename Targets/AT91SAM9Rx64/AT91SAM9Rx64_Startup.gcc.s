...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    .global  PreStackInit
    .global  ARM_Vectors
    .global AT91SAM9Rx64_CPU_InvalidateTLBs_asm
    .global AT91SAM9Rx64_CPU_EnableMMU_asm
    .global AT91SAM9Rx64_CPU_DisableMMU_asm
    .global AT91SAM9Rx64_CPU_IsMMUEnabled_asm
    ...
    .extern AT91SAM9Rx64_Interrupt_UndefHandler               @ void AT91SAM9Rx64_Interrupt_UndefHandler  (unsigned int*, unsigned int, unsigned int)
    .extern AT91SAM9Rx64_Interrupt_AbortpHandler              @ void AT91SAM9Rx64_Interrupt_AbortpHandler (unsigned int*, unsigned int, unsigned int)
    .extern AT91SAM9Rx64_Interrupt_AbortdHandler              @ void AT91SAM9Rx64_Interrupt_AbortdHandler (unsigned int*, unsigned int, unsigned int)
...
AT91SAM9Rx64_CPU_EnableMMU_asm:
...
AT91SAM9Rx64_CPU_IsMMUEnabled_asm:
    mrc     p15, 0, r0, c1, c0, 0
    mrc     p15, 0, r1, c2, c0, 0
    nop
...
UNDEF_Handler_Ptr:
    .word   AT91SAM9Rx64_Interrupt_UndefHandler
...
ABORTP_Handler_Ptr:
    .word   AT91SAM9Rx64_Interrupt_AbortpHandler
...
ABORTD_Handler_Ptr:
    .word   AT91SAM9Rx64_Interrupt_AbortdHandler
