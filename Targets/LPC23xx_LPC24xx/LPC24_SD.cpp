...
static const LPC24_Gpio_Pin g_LPC24_SdCard_Data1_Pins[] = LPC24_SD_DATA1_PINS;
static const LPC24_Gpio_Pin g_LPC24_SdCard_Data2_Pins[] = LPC24_SD_DATA2_PINS;
static const LPC24_Gpio_Pin g_LPC24_SdCard_Data3_Pins[] = LPC24_SD_DATA3_PINS;
static const LPC24_Gpio_Pin g_LPC24_SdCard_Clk_Pins[] = LPC24_SD_CLK_PINS;
...
const TinyCLR_Api_Info* LPC24_SdCard_GetApi() {
    ...
    sdCardProvider.GetControllerCount = &LPC24_SdCard_GetControllerCount;

    sdCardProvider.WriteSectors = &LPC24_SdCard_WriteSector;
    sdCardProvider.ReadSectors = &LPC24_SdCard_ReadSector;
    sdCardProvider.EraseSectors = &LPC24_SdCard_EraseSector;
...
TinyCLR_Result LPC24_SdCard_Acquire(const TinyCLR_SdCard_Provider* self, int32_t controller) {
    ...
    LPC24_GpioInternal_ConfigurePin(d0.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::PullUp, d0.alternateFunction);
    LPC24_GpioInternal_ConfigurePin(d1.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::PullUp, d1.alternateFunction);
    LPC24_GpioInternal_ConfigurePin(d2.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::PullUp, d2.alternateFunction);
    LPC24_GpioInternal_ConfigurePin(d3.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::PullUp, d3.alternateFunction);
    LPC24_GpioInternal_ConfigurePin(clk.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::None, clk.alternateFunction);
    LPC24_GpioInternal_ConfigurePin(cmd.number, LPC24_Gpio_PortMode::AlternateFunction, LPC24_Gpio_OutputType::PushPull, LPC24_Gpio_OutputSpeed::High, LPC24_Gpio_PullDirection::PullUp, cmd.alternateFunction);
...
TinyCLR_Result LPC24_SdCard_GetControllerCount(const TinyCLR_SdCard_Provider* self, int32_t& count) {
    count = SIZEOF_ARRAY(g_LPC24_SdCard_Data0_Pins);
...
TinyCLR_Result LPC24_SdCard_WriteSector(const TinyCLR_SdCard_Provider* self, int32_t controller, uint64_t sector, size_t& count, const uint8_t* data, int32_t timeout) {
    ...
    while (sectorCount) {
        ...
        if (to > 0 && SD_WriteBlock(&pData[index], sectorNum * LPC24_SD_SECTOR_SIZE, LPC24_SD_SECTOR_SIZE) == SD_OK) {
...
TinyCLR_Result LPC24_SdCard_ReadSector(const TinyCLR_SdCard_Provider* self, int32_t controller, uint64_t sector, size_t& count, uint8_t* data, int32_t timeout) {
    ...
    while (sectorCount) {
        ...
        if (to > 0 && SD_ReadBlock(&data[index], sectorNum * LPC24_SD_SECTOR_SIZE, LPC24_SD_SECTOR_SIZE) == SD_OK) {
...
TinyCLR_Result LPC24_SdCard_GetSectorMap(const TinyCLR_SdCard_Provider* self, int32_t controller, const size_t*& sizes, size_t& count, bool& isUniform) {
    sdController[controller].sectorSizes[0] = LPC24_SD_SECTOR_SIZE;

    sizes = sdController[controller].sectorSizes;
    count = SDCardInfo.CardCapacity / LPC24_SD_SECTOR_SIZE;
