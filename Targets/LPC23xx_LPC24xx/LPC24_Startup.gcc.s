...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    .extern LPC24_Interrupt_UndefHandler               @ void LPC24_Interrupt_UndefHandler  (unsigned int*, unsigned int, unsigned int)
    .extern LPC24_Interrupt_AbortpHandler              @ void LPC24_Interrupt_AbortpHandler (unsigned int*, unsigned int, unsigned int)
    .extern LPC24_Interrupt_AbortdHandler              @ void LPC24_Interrupt_AbortdHandler (unsigned int*, unsigned int, unsigned int)
    .extern IRQ_Handler
    .extern  ARM_Vectors
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    .section SectionForStackBottom,       "w", %progbits
StackBottom:
    .word   0
    .section SectionForStackTop,          "w", %progbits
StackTop:
    .word   0
...
UNDEF_Handler_Ptr:
    .word   LPC24_Interrupt_UndefHandler
...
ABORTP_Handler_Ptr:
    .word   LPC24_Interrupt_AbortpHandler
...
ABORTD_Handler_Ptr:
    .word   LPC24_Interrupt_AbortdHandler
