...
TinyCLR_Result LPC24_Gpio_Acquire(const TinyCLR_Gpio_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Gpio_Release(const TinyCLR_Gpio_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Gpio_EnableAlternatePin(int32_t pin, TinyCLR_Gpio_PinDriveMode resistor, uint32_t alternate);
TinyCLR_Result LPC24_Gpio_Read(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinValue& value);
TinyCLR_Result LPC24_Gpio_Write(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinValue value);
TinyCLR_Result LPC24_Gpio_SetDebounceTimeout(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, uint64_t debounceTicks);
TinyCLR_Result LPC24_Gpio_SetDriveMode(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
TinyCLR_Result LPC24_Gpio_AcquirePin(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
bool LPC24_Gpio_IsDriveModeSupported(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
TinyCLR_Gpio_PinDriveMode LPC24_Gpio_GetDriveMode(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
uint64_t LPC24_Gpio_GetDebounceTimeout(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
int32_t LPC24_Gpio_GetPinCount(const TinyCLR_Gpio_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Gpio_SetValueChangedHandler(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_ValueChangedHandler ISR);
TinyCLR_Result LPC24_Gpio_ReleasePin(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
...
TinyCLR_Result LPC24_Adc_Acquire(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Adc_Release(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Adc_AcquireChannel(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result LPC24_Adc_ReleaseChannel(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result LPC24_Adc_ReadValue(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel, int32_t& value);
int32_t LPC24_Adc_GetChannelCount(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t LPC24_Adc_GetResolutionInBits(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t LPC24_Adc_GetMinValue(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t LPC24_Adc_GetMaxValue(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Adc_ChannelMode LPC24_Adc_GetChannelMode(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Adc_SetChannelMode(const TinyCLR_Adc_Controller* self, int32_t controller, TinyCLR_Adc_ChannelMode mode);
bool LPC24_Adc_IsChannelModeSupported(const TinyCLR_Adc_Controller* self, int32_t controller, TinyCLR_Adc_ChannelMode mode);
TinyCLR_Result LPC24_Adc_GetControllerCount(const TinyCLR_Adc_Controller* self, int32_t& count);
...
TinyCLR_Result LPC24_Dac_Acquire(const TinyCLR_Dac_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Dac_Release(const TinyCLR_Dac_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Dac_AcquireChannel(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result LPC24_Dac_ReleaseChannel(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result LPC24_Dac_WriteValue(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel, int32_t value);
int32_t LPC24_Dac_GetChannelCount(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t LPC24_Dac_GetResolutionInBits(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t LPC24_Dac_GetMinValue(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t LPC24_Dac_GetMaxValue(const TinyCLR_Dac_Controller* self, int32_t controller);
...
TinyCLR_Result LPC24_Pwm_Acquire(const TinyCLR_Pwm_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Pwm_Release(const TinyCLR_Pwm_Controller* self, int32_t controller);
int32_t LPC24_Pwm_GetGpioPinForChannel(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result LPC24_Pwm_SetDesiredFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller, double& frequency);
TinyCLR_Result LPC24_Pwm_AcquirePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result LPC24_Pwm_ReleasePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result LPC24_Pwm_EnablePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result LPC24_Pwm_DisablePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result LPC24_Pwm_SetPulseParameters(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin, double dutyCycle, bool invertPolarity);
double LPC24_Pwm_GetMinFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
double LPC24_Pwm_GetMaxFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
double LPC24_Pwm_GetActualFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
int32_t LPC24_Pwm_GetPinCount(const TinyCLR_Pwm_Controller* self, int32_t controller);
...
TinyCLR_Result LPC24_SdCard_Acquire(const TinyCLR_SdCard_Controller* self, int32_t controller);
TinyCLR_Result LPC24_SdCard_Release(const TinyCLR_SdCard_Controller* self, int32_t controller);
TinyCLR_Result LPC24_SdCard_GetControllerCount(const TinyCLR_SdCard_Controller* self, int32_t& count);

TinyCLR_Result LPC24_SdCard_ReadSector(const TinyCLR_SdCard_Controller* self, int32_t controller, uint64_t sector, size_t& count, uint8_t* data, int32_t timeout);
TinyCLR_Result LPC24_SdCard_WriteSector(const TinyCLR_SdCard_Controller* self, int32_t controller, uint64_t sector, size_t& count, const uint8_t* data, int32_t timeout);
TinyCLR_Result LPC24_SdCard_IsSectorErased(const TinyCLR_SdCard_Controller* self, int32_t controller, uint64_t sector, bool& erased);
TinyCLR_Result LPC24_SdCard_EraseSector(const TinyCLR_SdCard_Controller* self, int32_t controller, uint64_t sector, size_t& count, int32_t timeout);
TinyCLR_Result LPC24_SdCard_GetSectorMap(const TinyCLR_SdCard_Controller* self, int32_t controller, const size_t*& sizes, size_t& count, bool& isUniform);
...
TinyCLR_Result LPC24_Spi_Acquire(const TinyCLR_Spi_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Spi_Release(const TinyCLR_Spi_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Spi_SetActiveSettings(const TinyCLR_Spi_Controller* self, int32_t controller, int32_t chipSelectLine, int32_t clockFrequency, int32_t dataBitLength, TinyCLR_Spi_Mode mode);
TinyCLR_Result LPC24_Spi_Read(const TinyCLR_Spi_Controller* self, int32_t controller, uint8_t* buffer, size_t& length);
TinyCLR_Result LPC24_Spi_Write(const TinyCLR_Spi_Controller* self, int32_t controller, const uint8_t* buffer, size_t& length);
TinyCLR_Result LPC24_Spi_TransferFullDuplex(const TinyCLR_Spi_Controller* self, int32_t controller, const uint8_t* writeBuffer, size_t& writeLength, uint8_t* readBuffer, size_t& readLength);
TinyCLR_Result LPC24_Spi_TransferSequential(const TinyCLR_Spi_Controller* self, int32_t controller, const uint8_t* writeBuffer, size_t& writeLength, uint8_t* readBuffer, size_t& readLength);
int32_t LPC24_Spi_GetChipSelectLineCount(const TinyCLR_Spi_Controller* self, int32_t controller);
int32_t LPC24_Spi_GetMinClockFrequency(const TinyCLR_Spi_Controller* self, int32_t controller);
int32_t LPC24_Spi_GetMaxClockFrequency(const TinyCLR_Spi_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Spi_GetSupportedDataBitLengths(const TinyCLR_Spi_Controller* self, int32_t controller, int32_t* dataBitLengths, size_t& dataBitLengthsCount);
...
TinyCLR_Result LPC24_Uart_Acquire(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Uart_Release(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Uart_SetActiveSettings(const TinyCLR_Uart_Controller* self, int32_t controller, uint32_t baudRate, uint32_t dataBits, TinyCLR_Uart_Parity parity, TinyCLR_Uart_StopBitCount stopBits, TinyCLR_Uart_Handshake handshaking);
TinyCLR_Result LPC24_Uart_Flush(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Uart_Read(const TinyCLR_Uart_Controller* self, int32_t controller, uint8_t* buffer, size_t& length);
TinyCLR_Result LPC24_Uart_Write(const TinyCLR_Uart_Controller* self, int32_t controller, const uint8_t* buffer, size_t& length);
TinyCLR_Result LPC24_Uart_SetPinChangedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_PinChangedHandler handler);
TinyCLR_Result LPC24_Uart_SetErrorReceivedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_ErrorReceivedHandler handler);
TinyCLR_Result LPC24_Uart_SetDataReceivedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_DataReceivedHandler handler);
TinyCLR_Result LPC24_Uart_GetBreakSignalState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_SetBreakSignalState(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result LPC24_Uart_GetCarrierDetectState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_GetClearToSendState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_GetDataReadyState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_GetIsDataTerminalReadyEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_SetIsDataTerminalReadyEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result LPC24_Uart_GetIsRequestToSendEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result LPC24_Uart_SetIsRequestToSendEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result LPC24_Uart_GetReadBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& size);
TinyCLR_Result LPC24_Uart_SetReadBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t size);
TinyCLR_Result LPC24_Uart_GetWriteBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& size);
TinyCLR_Result LPC24_Uart_SetWriteBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t size);
TinyCLR_Result LPC24_Uart_GetUnreadCount(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& count);
TinyCLR_Result LPC24_Uart_GetUnwrittenCount(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& count);
TinyCLR_Result LPC24_Uart_ClearReadBuffer(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Uart_ClearWriteBuffer(const TinyCLR_Uart_Controller* self, int32_t controller);
...
bool LPC24_Deployment_IsSupportsXIP(const TinyCLR_Deployment_Controller* self);
...
TinyCLR_Result LPC24_Display_Acquire(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Display_Release(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Display_Enable(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Display_Disable(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result LPC24_Display_GetCapabilities(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_InterfaceType& type, const TinyCLR_Display_DataFormat*& supportedDataFormats, size_t& supportedDataFormatCount);
TinyCLR_Result LPC24_Display_GetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat& dataFormat, uint32_t& width, uint32_t& height, void* configuration);
TinyCLR_Result LPC24_Display_SetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat dataFormat, uint32_t width, uint32_t height, const void* configuration);
TinyCLR_Result LPC24_Display_DrawBuffer(const TinyCLR_Display_Controller* self, int32_t controller, int32_t x, int32_t y, int32_t width, int32_t height, const uint8_t* data);
TinyCLR_Result LPC24_Display_WriteString(const TinyCLR_Display_Controller* self, int32_t controller, const char* buffer, size_t length);
