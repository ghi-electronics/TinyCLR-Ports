...
#define AT91SAM9X35_RTC_TIMR_AM    (0x0)
#define AT91SAM9X35_RTC_TIMR_PM    (0x1)
...
const char* rtcApiNames[TOTAL_RTC_CONTROLLERS] = {
    "GHIElectronics.TinyCLR.NativeApis.AT91SAM9X35.RtcController\\0"
};
...
void AT91SAM9X35_Rtc_AddApi(const TinyCLR_Api_Manager* apiManager) {
    for (auto i = 0; i < TOTAL_RTC_CONTROLLERS; i++) {
        ...
        rtcControllers[i].Acquire = &AT91SAM9X35_Rtc_Acquire;
        rtcControllers[i].Release = &AT91SAM9X35_Rtc_Release;
        rtcControllers[i].IsValid = &AT91SAM9X35_Rtc_IsValid;
        rtcControllers[i].GetTime = &AT91SAM9X35_Rtc_GetTime;
        rtcControllers[i].SetTime = &AT91SAM9X35_Rtc_SetTime;
...
void AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(uint32_t valueToConvert, uint32_t &tens, uint32_t &ones) {
    tens = valueToConvert / 10;
    ones = valueToConvert % 10;
}

uint32_t AT91SAM9X35_Rtc_BinaryCodedDecimalCombine(uint32_t tens, uint32_t ones) {
...
TinyCLR_Result AT91SAM9X35_Rtc_Acquire(const TinyCLR_Rtc_Controller* self) {
    if ((PMC_MCKR & AT91C_PMC_CSS) != 0) {
        ...
        AT91SAM9X35_Time_Delay(nullptr, 100000);
...
TinyCLR_Result AT91SAM9X35_Rtc_IsValid(const TinyCLR_Rtc_Controller* self, bool& value) {
    ...
    value = (AT91SAM9X35_Rtc_GetTime(self, rtcNow) == TinyCLR_Result::Success);
...
TinyCLR_Result AT91SAM9X35_Rtc_GetTime(const TinyCLR_Rtc_Controller* self, TinyCLR_Rtc_DateTime& value) {
    ...
    if (RTC_VER > 0) { // Valid Entry Register, detect any incorrect value this register will be not 0.
        ...
        hundredYear = AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((calenderRegister & (0xFF << 8)) >> 8) >> 4), (((calenderRegister & (0xFF << 8)) >> 8) & 0xF));
        value.Year = (uint32_t)(fullYear + hundredYear);
        value.Month = (uint32_t)AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((calenderRegister & (0x1F << 16)) >> 16) >> 4), (((calenderRegister & (0x1F << 16)) >> 16) & 0xF));
        value.DayOfMonth = (uint32_t)AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((calenderRegister & (0x3F << 24)) >> 24) >> 4), (((calenderRegister & (0x3F << 24)) >> 24) & 0xF));
        value.DayOfWeek = (uint32_t)AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((calenderRegister & (0x07 << 21)) >> 21) >> 4), (((calenderRegister & (0x07 << 21)) >> 21) & 0xF));
        value.Hour = AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((timeRegister & (0x3F << 16)) >> 16) >> 4), (((timeRegister & (0x3F << 16)) >> 16) & 0xF));

        if (((timeRegister & 0x400000) >> 22) == AT91SAM9X35_RTC_TIMR_PM)
            value.Hour = value.Hour + 12;
        else
            value.Hour = value.Hour;

        value.Minute = (uint32_t)AT91SAM9X35_Rtc_BinaryCodedDecimalCombine((((timeRegister & (0x7F << 8)) >> 8) >> 4), (((timeRegister & (0x7F << 8)) >> 8) & 0xF));
        value.Second = (uint32_t)AT91SAM9X35_Rtc_BinaryCodedDecimalCombine(((timeRegister & 0x7F) >> 4), ((timeRegister & 0x7F) & 0xF));
        value.Millisecond = 1;
    }
...
TinyCLR_Result AT91SAM9X35_Rtc_SetTime(const TinyCLR_Rtc_Controller* self, TinyCLR_Rtc_DateTime value) {
    ...
    // Add value.Year
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(lowerHundredYears, tens, ones);
    calenderRegister |= (uint32_t)((tens << 12) | (ones << 8));
    // Add value.Month
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(value.Month, tens, ones);
    calenderRegister |= (uint32_t)((tens << 20) | (ones << 16));
    // Add dayOfWeek
    calenderRegister |= (uint32_t)(((value.DayOfWeek + 1) << 21));
    // Add value.DayOfMonth
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(value.DayOfMonth, tens, ones);
    calenderRegister |= (uint32_t)((tens << 28) | (ones << 24));

    AT91SAM9X35_Time_Delay(nullptr, 500000);
    ...
    // Add hour
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(value.Hour, tens, ones);
    timeRegister = (uint32_t)((AT91SAM9X35_RTC_TIMR_AM << 22) | (tens << 20) | (ones << 16));
    RTC_TIMR = timeRegister;

    // Add value.Minute
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(value.Minute, tens, ones);
    timeRegister = (uint32_t)((tens << 12) | (ones << 8));
    RTC_TIMR |= timeRegister;

    // Add value.Second
    AT91SAM9X35_Rtc_BinaryCodedDecimalExtract(value.Second, tens, ones);
