...
TinyCLR_Result STM32F4_Adc_Acquire(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Adc_Release(const TinyCLR_Adc_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Adc_AcquireChannel(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result STM32F4_Adc_ReleaseChannel(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result STM32F4_Adc_ReadValue(const TinyCLR_Adc_Controller* self, int32_t controller, int32_t channel, int32_t& value);
TinyCLR_Result STM32F4_Adc_SetChannelMode(const TinyCLR_Adc_Controller* self, int32_t controller, TinyCLR_Adc_ChannelMode mode);
TinyCLR_Adc_ChannelMode STM32F4_Adc_GetChannelMode(const TinyCLR_Adc_Controller* self, int32_t controller);
bool STM32F4_Adc_IsChannelModeSupported(const TinyCLR_Adc_Controller* self, int32_t controller, TinyCLR_Adc_ChannelMode mode);
int32_t STM32F4_Adc_GetMinValue(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t STM32F4_Adc_GetMaxValue(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t STM32F4_Adc_GetResolutionInBits(const TinyCLR_Adc_Controller* self, int32_t controller);
int32_t STM32F4_Adc_GetChannelCount(const TinyCLR_Adc_Controller* self, int32_t controller);
void STM32F4_Adc_Reset();
TinyCLR_Result STM32F4_Adc_GetControllerCount(const TinyCLR_Adc_Controller* self, int32_t& count);
...
TinyCLR_Result STM32F4_Dac_Acquire(const TinyCLR_Dac_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Dac_Release(const TinyCLR_Dac_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Dac_AcquireChannel(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result STM32F4_Dac_ReleaseChannel(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel);
TinyCLR_Result STM32F4_Dac_WriteValue(const TinyCLR_Dac_Controller* self, int32_t controller, int32_t channel, int32_t value);
int32_t STM32F4_Dac_GetMinValue(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t STM32F4_Dac_GetMaxValue(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t STM32F4_Dac_GetResolutionInBits(const TinyCLR_Dac_Controller* self, int32_t controller);
int32_t STM32F4_Dac_GetChannelCount(const TinyCLR_Dac_Controller* self, int32_t controller);
void STM32F4_Dac_Reset();
TinyCLR_Result STM32F4_Dac_GetControllerCount(const TinyCLR_Dac_Controller* self, int32_t& count);

////////////////////////////////////////////////////////////////////////////////
//GPIO
////////////////////////////////////////////////////////////////////////////////
const TinyCLR_Api_Info* STM32F4_Gpio_GetApi();
TinyCLR_Result STM32F4_Gpio_Acquire(const TinyCLR_Gpio_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Gpio_Release(const TinyCLR_Gpio_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Gpio_AcquirePin(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Gpio_ReleasePin(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Gpio_Read(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinValue& value);
TinyCLR_Result STM32F4_Gpio_Write(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinValue value);
bool STM32F4_Gpio_IsDriveModeSupported(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
TinyCLR_Gpio_PinDriveMode STM32F4_Gpio_GetDriveMode(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Gpio_SetDriveMode(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_PinDriveMode mode);
uint64_t STM32F4_Gpio_GetDebounceTimeout(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Gpio_SetDebounceTimeout(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, uint64_t debounceTicks);
TinyCLR_Result STM32F4_Gpio_SetValueChangedHandler(const TinyCLR_Gpio_Controller* self, int32_t controller, int32_t pin, TinyCLR_Gpio_ValueChangedHandler handler);
int32_t STM32F4_Gpio_GetPinCount(const TinyCLR_Gpio_Controller* self, int32_t controller);
void STM32F4_Gpio_Reset();
TinyCLR_Result STM32F4_Gpio_GetControllerCount(const TinyCLR_Gpio_Controller* self, int32_t& count);
...
TinyCLR_Result STM32F4_Pwm_Acquire(const TinyCLR_Pwm_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Pwm_Release(const TinyCLR_Pwm_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Pwm_AcquirePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Pwm_ReleasePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Pwm_EnablePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Pwm_DisablePin(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin);
TinyCLR_Result STM32F4_Pwm_SetPulseParameters(const TinyCLR_Pwm_Controller* self, int32_t controller, int32_t pin, double dutyCycle, bool invertPolarity);
TinyCLR_Result STM32F4_Pwm_SetDesiredFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller, double& frequency);
double STM32F4_Pwm_GetMinFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
double STM32F4_Pwm_GetMaxFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
double STM32F4_Pwm_GetActualFrequency(const TinyCLR_Pwm_Controller* self, int32_t controller);
int32_t STM32F4_Pwm_GetPinCount(const TinyCLR_Pwm_Controller* self, int32_t controller);
void STM32F4_Pwm_Reset();
TinyCLR_Result STM32F4_Pwm_GetControllerCount(const TinyCLR_Pwm_Controller* self, int32_t& count);
...
TinyCLR_Result STM32F4_Uart_Acquire(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Uart_Release(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Uart_SetActiveSettings(const TinyCLR_Uart_Controller* self, int32_t controller, uint32_t baudRate, uint32_t dataBits, TinyCLR_Uart_Parity parity, TinyCLR_Uart_StopBitCount stopBits, TinyCLR_Uart_Handshake handshaking);
TinyCLR_Result STM32F4_Uart_Flush(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Uart_Read(const TinyCLR_Uart_Controller* self, int32_t controller, uint8_t* buffer, size_t& length);
TinyCLR_Result STM32F4_Uart_Write(const TinyCLR_Uart_Controller* self, int32_t controller, const uint8_t* buffer, size_t& length);
TinyCLR_Result STM32F4_Uart_SetPinChangedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_PinChangedHandler handler);
TinyCLR_Result STM32F4_Uart_SetErrorReceivedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_ErrorReceivedHandler handler);
TinyCLR_Result STM32F4_Uart_SetDataReceivedHandler(const TinyCLR_Uart_Controller* self, int32_t controller, TinyCLR_Uart_DataReceivedHandler handler);
TinyCLR_Result STM32F4_Uart_GetBreakSignalState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_SetBreakSignalState(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result STM32F4_Uart_GetCarrierDetectState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_GetClearToSendState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_GetDataReadyState(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_GetIsDataTerminalReadyEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_SetIsDataTerminalReadyEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result STM32F4_Uart_GetIsRequestToSendEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool& state);
TinyCLR_Result STM32F4_Uart_SetIsRequestToSendEnabled(const TinyCLR_Uart_Controller* self, int32_t controller, bool state);
TinyCLR_Result STM32F4_Uart_GetReadBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& size);
TinyCLR_Result STM32F4_Uart_SetReadBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t size);
TinyCLR_Result STM32F4_Uart_GetWriteBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& size);
TinyCLR_Result STM32F4_Uart_SetWriteBufferSize(const TinyCLR_Uart_Controller* self, int32_t controller, size_t size);
TinyCLR_Result STM32F4_Uart_GetUnreadCount(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& count);
TinyCLR_Result STM32F4_Uart_GetUnwrittenCount(const TinyCLR_Uart_Controller* self, int32_t controller, size_t& count);
TinyCLR_Result STM32F4_Uart_ClearReadBuffer(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Uart_ClearWriteBuffer(const TinyCLR_Uart_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Uart_GetControllerCount(const TinyCLR_Uart_Controller* self, int32_t& count);
...
TinyCLR_Result STM32F4_Display_Acquire(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Display_Release(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Display_Enable(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Display_Disable(const TinyCLR_Display_Controller* self, int32_t controller);
TinyCLR_Result STM32F4_Display_GetCapabilities(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_InterfaceType& type, const TinyCLR_Display_DataFormat*& supportedDataFormats, size_t& supportedDataFormatCount);
TinyCLR_Result STM32F4_Display_GetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat& dataFormat, uint32_t& width, uint32_t& height, void* configuration);
TinyCLR_Result STM32F4_Display_SetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat dataFormat, uint32_t width, uint32_t height, const void* configuration);
TinyCLR_Result STM32F4_Display_DrawBuffer(const TinyCLR_Display_Controller* self, int32_t controller, int32_t x, int32_t y, int32_t width, int32_t height, const uint8_t* data);
TinyCLR_Result STM32F4_Display_WriteString(const TinyCLR_Display_Controller* self, int32_t controller, const char* buffer, size_t length);

void STM32F4_Startup_OnSoftReset(const TinyCLR_Api_Manager* apiProvider, const TinyCLR_Interop_Manager* interopProvider);
void STM32F4_Startup_OnSoftResetDevice(const TinyCLR_Api_Manager* apiProvider, const TinyCLR_Interop_Manager* interopProvider);
