...
uint32_t g_AT45DB321D_Flash_SpiController;
...
uint8_t AT45DB321D_Flash_GetStatus() {
    ...
    g_AT45DB321D_Flash_SpiProvider->TransferFullDuplex(g_AT45DB321D_Flash_SpiProvider, g_AT45DB321D_Flash_SpiController, g_AT45DB321D_Flash_DataWriteBuffer, writeLength, g_AT45DB321D_Flash_DataReadBuffer, readLength);
...
TinyCLR_Result AT45DB321D_Flash_Read(uint32_t address, size_t length, uint8_t* buffer) {
    ...
    g_AT45DB321D_Flash_SpiProvider->Acquire(g_AT45DB321D_Flash_SpiProvider, g_AT45DB321D_Flash_SpiController);

    g_AT45DB321D_Flash_SpiProvider->SetActiveSettings(g_AT45DB321D_Flash_SpiProvider, g_AT45DB321D_Flash_SpiController, g_AT45DB321D_Flash_SpiChipSelectLine, AT45DB321D_SPI_CLOCK_HZ, 8, TinyCLR_Spi_Mode::Mode0);
    ...
    g_AT45DB321D_Flash_SpiProvider->Release(g_AT45DB321D_Flash_SpiProvider, g_AT45DB321D_Flash_SpiController);
...
TinyCLR_Result AT45DB321D_Flash_Acquire(const TinyCLR_Spi_Provider* spiProvider, int32_t controller, const TinyCLR_NativeTime_Provider* timeProvider, uint32_t chipSelectLine, bool& supportXIP) {
    ...
    g_AT45DB321D_Flash_SpiController = controller;
