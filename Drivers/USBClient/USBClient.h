...
TinyCLR_Result TinyCLR_UsbClient_Open(const TinyCLR_UsbClient_Controller* self, int32_t controller, int32_t& pipe, uint8_t writeEndpoint, uint8_t readEndpoint);
