...
struct Interop_GHIElectronics_TinyCLR_Devices_Signals_GHIElectronics_TinyCLR_Devices_Signals_PulseFeedback {
    ...
    static const size_t FIELD___PulsePinDriveMode__BackingField___GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPinDriveMode = 12;
    static const size_t FIELD___EchoPinDriveMode__BackingField___GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPinDriveMode = 13;

    static TinyCLR_Result GeneratePulse___mscorlibSystemTimeSpan(const TinyCLR_Interop_MethodData md);
};
...
struct Interop_GHIElectronics_TinyCLR_Devices_Signals_GHIElectronics_TinyCLR_Devices_Signals_SignalCapture {
    ...
    static TinyCLR_Result Read___I4__BYREF_GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPinValue__SZARRAY_mscorlibSystemTimeSpan__I4__I4(const TinyCLR_Interop_MethodData md);
    static TinyCLR_Result Read___I4__GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPinValue__SZARRAY_mscorlibSystemTimeSpan__I4__I4(const TinyCLR_Interop_MethodData md);
};
...
struct Interop_GHIElectronics_TinyCLR_Devices_Signals_GHIElectronics_TinyCLR_Devices_Signals_SignalGenerator {
    ...
    static const size_t FIELD___pinNumber___I4 = 2;
    static const size_t FIELD___pin___GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPin = 3;
    static const size_t FIELD___idleValue___GHIElectronicsTinyCLRDevicesGpioGHIElectronicsTinyCLRDevicesGpioGpioPinValue = 4;
    static const size_t FIELD___DisableInterrupts__BackingField___BOOLEAN = 5;
    static const size_t FIELD___GenerateCarrierFrequency__BackingField___BOOLEAN = 6;
    static const size_t FIELD___CarrierFrequency__BackingField___I8 = 7;

    static TinyCLR_Result Write___VOID__SZARRAY_mscorlibSystemTimeSpan__I4__I4(const TinyCLR_Interop_MethodData md);
};
