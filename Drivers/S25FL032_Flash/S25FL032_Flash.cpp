...
TinyCLR_Result S25FL032_Flash_Read(uint32_t address, size_t length, uint8_t* buffer) {
    ...
    s25fl032FlashSpiProvider->SetActiveSettings(s25fl032FlashSpiProvider, s25fl032FlashSpiChipSelectLine, TinyCLR_Spi_ChipSelectType::Gpio, 0, 0, false, SPI_CLOCK_RATE_HZ, 8, TinyCLR_Spi_Mode::Mode0);
