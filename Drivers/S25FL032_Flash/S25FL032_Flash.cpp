...
bool S25FL032_Flash_WriteEnable() {
    ...
    g_S25FL032_Flash_SpiProvider->TransferFullDuplex(g_S25FL032_Flash_SpiProvider, spiController, g_S25FL032_Flash_DataWriteBuffer, writeLength, g_S25FL032_Flash_DataReadBuffer, readLength);
...
TinyCLR_Result S25FL032_Flash_Read(uint32_t address, size_t length, uint8_t* buffer) {
    ...
    g_S25FL032_Flash_SpiProvider->Acquire(g_S25FL032_Flash_SpiProvider, spiController);

    g_S25FL032_Flash_SpiProvider->SetActiveSettings(g_S25FL032_Flash_SpiProvider, spiController, g_S25FL032_Flash_SpiChipSelectLine, SPI_CLOCK_RATE_HZ, 8, TinyCLR_Spi_Mode::Mode0);
    ...
    g_S25FL032_Flash_SpiProvider->Release(g_S25FL032_Flash_SpiProvider, spiController);
...
TinyCLR_Result S25FL032_Flash_PageProgram(uint32_t byteAddress, uint32_t NumberOfBytesToWrite, const uint8_t * pointerToWriteBuffer) {
    ...
    while (block_cnt > 0) {
        ...
        // Write cmd to Write
        g_S25FL032_Flash_SpiProvider->Write(g_S25FL032_Flash_SpiProvider, spiController, g_S25FL032_Flash_DataWriteBuffer, actualWrite);
...
TinyCLR_Result S25FL032_Flash_EraseBlock(uint32_t sector) {
    ...
    g_S25FL032_Flash_SpiProvider->Write(g_S25FL032_Flash_SpiProvider, spiController, g_S25FL032_Flash_DataWriteBuffer, writeLength);
