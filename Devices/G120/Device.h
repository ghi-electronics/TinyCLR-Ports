...
#define LPC17_DISPLAY_CONTROLLER_RED_PINS   { { PIN(1, 20), PF(7) }, { PIN(1, 21), PF(7) }, { PIN(1, 22), PF(7) }, { PIN(1, 23), PF(7) }, { PIN(1, 24), PF(7) }  }
#define LPC17_DISPLAY_CONTROLLER_GREEN_PINS { { PIN(1, 25), PF(7) }, { PIN(1, 26), PF(7) }, { PIN(1, 27), PF(7) }, { PIN(1, 28), PF(7)}, { PIN(1, 29), PF(7) }, { PIN(2, 13), PF(7) }  }
#define LPC17_DISPLAY_CONTROLLER_BLUE_PINS  { { PIN(2, 12), PF(5) }, { PIN(2, 9), PF(7) } , { PIN(2, 6), PF(7) }, { PIN(2, 7), PF(7) }, { PIN(2, 8), PF(7) }  }
